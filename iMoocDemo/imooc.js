...
window.onload= function () {
	var blueDiv = document.getElementById('tab');
	var blueUL = blueDiv.getElementsByTagName('ul')[0];
	var	oText = blueDiv.getElementsByTagName('div')[0];
	var aBtn = blueUL.getElementsByTagName('li');
